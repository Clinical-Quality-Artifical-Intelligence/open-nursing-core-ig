...
| Active as of 2026-07-10 | *Computable Name*:ONCRespirationRate |
...
* Examples for this Profile: [Observation/example-respiration-rate](Observation-example-respiration-rate.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-respiration-rate.json)
