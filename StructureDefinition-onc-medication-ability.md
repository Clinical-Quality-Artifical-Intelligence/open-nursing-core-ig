# Medication Management Ability - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-medication-ability | *Version*:1.0.0 |
| Active as of 2026-07-09 | *Computable Name*:ONCMedicationAbility |
...
* Examples for this Profile: [Observation/example-medication-ability](Observation-example-medication-ability.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-medication-ability.json)
