# example-oral-intake - Open Nursing Core FHIR Implementation Guide (ONC-IG) v0.1.0
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "https://opennursingcoreig.com/StructureDefinition/onc-oral-intake-assessment"
    ]
  },
  "status" : "final",
  "category" : [
