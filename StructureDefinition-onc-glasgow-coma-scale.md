...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-glasgow-coma-scale | *Version*:1.0.0 |
| Active as of 2026-07-11 | *Computable Name*:ONCGlasgowComaScale |
...
* Examples for this Profile: [Observation/example-gcs](Observation-example-gcs.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-glasgow-coma-scale.json)
