# Seizure Record - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.clinyq.ai/StructureDefinition/onc-seizure-record | *Version*:1.0.0 |
