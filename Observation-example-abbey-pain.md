# example-abbey-pain - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://opennursingcoreig.com/StructureDefinition/onc-abbey-pain-scale"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
