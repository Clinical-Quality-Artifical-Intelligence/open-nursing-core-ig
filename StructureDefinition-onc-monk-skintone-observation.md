...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-monk-skintone-observation | *Version*:1.0.0 |
| Active as of 2026-07-11 | *Computable Name*:ONCMonkSkinToneObservation |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-monk-skintone-observation.json)
