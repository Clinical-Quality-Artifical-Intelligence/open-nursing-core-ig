# Clinical Frailty Scale (CFS) - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-clinical-frailty-scale | *Version*:1.0.0 |
| Draft as of 2026-07-11 | *Computable Name*:ONCClinicalFrailtyScale |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-clinical-frailty-scale.json)
