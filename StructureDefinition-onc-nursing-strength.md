# ONC Nursing Strength - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ONC Nursing Strength**

## Resource Profile: ONC Nursing Strength 

| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-nursing-strength | *Version*:1.0.0 |
| Active as of 2026-07-11 | *Computable Name*:ONCNursingStrength |
...
Other representations of profile: [CSV](StructureDefinition-onc-nursing-strength.csv), [Excel](StructureDefinition-onc-nursing-strength.xlsx), [Schematron](StructureDefinition-onc-nursing-strength.sch) 
...
```json
{
  ...
  "url" : "https://opennursingcoreig.com/StructureDefinition/onc-nursing-strength",
  "version" : "1.0.0",
