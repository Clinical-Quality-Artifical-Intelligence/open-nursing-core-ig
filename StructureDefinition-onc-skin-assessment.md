# Skin Integrity Assessment - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-skin-assessment | *Version*:1.0.0 |
| Active as of 2026-07-04 | *Computable Name*:ONCSkinAssessment |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-skin-assessment.json)
