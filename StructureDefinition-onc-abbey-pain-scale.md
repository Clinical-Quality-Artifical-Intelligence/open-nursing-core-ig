...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-abbey-pain-scale | *Version*:1.0.0 |
| Draft as of 2026-07-09 | *Computable Name*:ONCAbbeyPainScale |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-abbey-pain-scale.json)
