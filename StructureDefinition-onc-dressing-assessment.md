...
## Resource Profile: Dressing and Undressing Assessment 

| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-dressing-assessment | *Version*:1.0.0 |
| Active as of 2026-07-09 | *Computable Name*:ONCDressingAssessment |
...
* Examples for this Profile: [Observation/ExampleDressingAssessment](Observation-ExampleDressingAssessment.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-dressing-assessment.json)
...
Other representations of profile: [CSV](StructureDefinition-onc-dressing-assessment.csv), [Excel](StructureDefinition-onc-dressing-assessment.xlsx), [Schematron](StructureDefinition-onc-dressing-assessment.sch) 
