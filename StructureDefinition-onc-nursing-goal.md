...
| Active as of 2026-07-11 | *Computable Name*:ONCNursingGoal |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-nursing-goal.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://opennursingcoreig.com/StructureDefinition/onc-nursing-problem"]
      }],
      "mustSupport" : true
    }]
  }
