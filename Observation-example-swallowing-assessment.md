# example-swallowing-assessment - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://opennursingcoreig.com/StructureDefinition/onc-swallowing-assessment"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
