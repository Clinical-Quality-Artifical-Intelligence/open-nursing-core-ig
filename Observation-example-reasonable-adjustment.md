# example-reasonable-adjustment - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://opennursingcoreig.com/StructureDefinition/onc-reasonable-adjustment"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
