...
| Active as of 2026-07-09 | *Computable Name*:ONCACVPU |
...
* Examples for this Profile: [Observation/example-acvpu](Observation-example-acvpu.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-acvpu.json)
