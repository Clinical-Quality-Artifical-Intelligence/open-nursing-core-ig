# example-medication-ability - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://opennursingcoreig.com/StructureDefinition/onc-medication-ability"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
