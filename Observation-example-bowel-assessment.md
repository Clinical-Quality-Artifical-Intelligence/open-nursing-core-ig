# example-bowel-assessment - Open Nursing Core FHIR Implementation Guide (ONC-IG) v0.1.0
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "https://opennursingcoreig.com/StructureDefinition/onc-bowel-assessment"
    ]
  },
  "status" : "final",
  "category" : [
