# Swallowing Assessment - Open Nursing Core FHIR Implementation Guide (ONC-IG) v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/StructureDefinition/onc-swallowing-assessment | *Version*:1.0.0 |
| Active as of 2026-07-09 | *Computable Name*:ONCSwallowingAssessment |
...
* Examples for this Profile: [Observation/example-swallowing-assessment](Observation-example-swallowing-assessment.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/onc.ig|current/StructureDefinition/StructureDefinition-onc-swallowing-assessment.json)
